...
export function createAdapter(client: FetchClient): {
   ...
   */
  deleteBucket: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }) => Promise<FetchResponse<boolean>>;
  /**
   * Get bucket
   *
	 * @param options - Request options (signal, timeout, operationId)
   * @returns Promise resolving to FetchResponse<BucketDetails>
   */
  getBucket: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }) => Promise<FetchResponse<BucketDetails>>;
  /**
   ...
   */
  listObjects: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }) => Promise<FetchResponse<ListObjectsResponse>>;
  /**
   * Delete object
   *
	 * @param options - Request options (signal, timeout, operationId)
   * @returns Promise resolving to FetchResponse<boolean>
   */
  deleteObject: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }) => Promise<FetchResponse<boolean>>;
  /**
   * Get object metadata
   *
	 * @param options - Request options (signal, timeout, operationId)
   ...
   */
  getObjectMetadata: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }) => Promise<FetchResponse<ObjectMetadata>>;
  /**
   ...
   */
  downloadObjectContent: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }) => Promise<FetchResponse<any>>;
  /**
   ...
   * @returns Promise resolving to FetchResponse<ObjectMetadata>
   */
  putObjectContent: (body: any, options?: { signal?: AbortSignal; timeout?: number; operationId?: string }) => Promise<FetchResponse<ObjectMetadata>>;
  /**
   * Get object tags
   *
	 * @param options - Request options (signal, timeout, operationId)
   ...
   */
  getObjectTags: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }) => Promise<FetchResponse<TagsResponse>>;
  /**
   * Replace object tags
   *
   * @param body - Request body
   ...
   * @returns Promise resolving to FetchResponse<TagsResponse>
   */
  putObjectTags: (body: TagsRequest, options?: { signal?: AbortSignal; timeout?: number; operationId?: string }) => Promise<FetchResponse<TagsResponse>>;
  /**
   ...
   */
  listObjectVersions: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }) => Promise<FetchResponse<ListVersionsResponse>>;
  /**
   ...
   */
  getBucketVersioning: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }) => Promise<FetchResponse<VersioningStatus>>;
  /**
  ...
  return {
	...
	return client.get(`/buckets/{bucketName}/objects`, undefined, finalOptions);
    },
    deleteObject: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }): Promise<FetchResponse<boolean>> => {
      const finalOptions = { ...options, operationId: options?.operationId ?? 'deleteObject' };
	return client.del(`/buckets/{bucketName}/objects/{objectKey}`, undefined, finalOptions);
    },
    getObjectMetadata: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }): Promise<FetchResponse<ObjectMetadata>> => {
      const finalOptions = { ...options, operationId: options?.operationId ?? 'getObjectMetadata' };
	return client.get(`/buckets/{bucketName}/objects/{objectKey}`, undefined, finalOptions);
    },
    downloadObjectContent: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }): Promise<FetchResponse<any>> => {
      const finalOptions = { ...options, operationId: options?.operationId ?? 'downloadObjectContent' };
	return client.get(`/buckets/{bucketName}/objects/{objectKey}/content`, undefined, finalOptions);
    },
    putObjectContent: (body: any, options?: { signal?: AbortSignal; timeout?: number; operationId?: string }): Promise<FetchResponse<ObjectMetadata>> => {
      const finalOptions = { ...options, operationId: options?.operationId ?? 'putObjectContent' };
	return client.put(`/buckets/{bucketName}/objects/{objectKey}/content`, body, undefined, finalOptions);
    },
    getObjectTags: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }): Promise<FetchResponse<TagsResponse>> => {
      const finalOptions = { ...options, operationId: options?.operationId ?? 'getObjectTags' };
	return client.get(`/buckets/{bucketName}/objects/{objectKey}/tags`, undefined, finalOptions);
    },
    putObjectTags: (body: TagsRequest, options?: { signal?: AbortSignal; timeout?: number; operationId?: string }): Promise<FetchResponse<TagsResponse>> => {
      const finalOptions = { ...options, operationId: options?.operationId ?? 'putObjectTags' };
	return client.put(`/buckets/{bucketName}/objects/{objectKey}/tags`, body, undefined, finalOptions);
    },
    listObjectVersions: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }): Promise<FetchResponse<ListVersionsResponse>> => {
      const finalOptions = { ...options, operationId: options?.operationId ?? 'listObjectVersions' };
	return client.get(`/buckets/{bucketName}/objects/{objectKey}/versions`, undefined, finalOptions);
    },
    getBucketVersioning: (options?: { signal?: AbortSignal; timeout?: number; operationId?: string }): Promise<FetchResponse<VersioningStatus>> => {
      const finalOptions = { ...options, operationId: options?.operationId ?? 'getBucketVersioning' };
	return client.get(`/buckets/{bucketName}/versioning`, undefined, finalOptions);
    },
    setBucketVersioning: (body: VersioningStatus, options?: { signal?: AbortSignal; timeout?: number; operationId?: string }): Promise<FetchResponse<VersioningStatus>> => {
      const finalOptions = { ...options, operationId: options?.operationId ?? 'setBucketVersioning' };
	return client.put(`/buckets/{bucketName}/versioning`, body, undefined, finalOptions);
    }
  };
}
